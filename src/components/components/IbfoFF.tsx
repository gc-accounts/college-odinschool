...
const IbfoFF = ({ sectionClass, cohortDates }: dsEliteProps) => {
      ...
      <div className="container grid md:grid-cols-12 gap-10 items-center justify-between">
        ...
        <div className='col-span-5'>
          ...
          <p className="text-white text-md mb-10">
            Upgraded for 2026 Industry Requirements | Ideal for Frshers & Working professionals
          </p>
